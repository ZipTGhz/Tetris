...
public class MainMenuPanel extends JPanel {
  ...
  private void setTheme() {
    try {
      ...
      image[1] =
        ImageIO.read(getClass().getResource("/img/style01/play01.png"));
      image[2] =
        ImageIO.read(getClass().getResource("/img/style01/play03.png"));
      playButton = image[1];
      playX = screenWidth / 2 - playButton.getWidth() / 2;
      playY = screenHeight / 2 - playButton.getHeight() / 2 - SIZE * 4;

      image[3] =
        ImageIO.read(getClass().getResource("/img/style01/information01.png"));
      image[4] =
        ImageIO.read(getClass().getResource("/img/style01/information03.png"));
      infoButton = image[3];
      infoX = screenWidth / 2 - infoButton.getWidth() / 2;
      infoY = screenHeight / 2 - infoButton.getHeight() / 2 - SIZE * 1;

      image[5] =
        ImageIO.read(getClass().getResource("/img/style01/option01.png"));
      image[6] =
        ImageIO.read(getClass().getResource("/img/style01/option03.png"));
      optButton = image[5];
      optX = screenWidth / 2 - optButton.getWidth() / 2;
      optY = screenHeight / 2 - optButton.getHeight() / 2 + SIZE * 2;

      image[7] =
        ImageIO.read(getClass().getResource("/img/style01/about01.png"));
      image[8] =
        ImageIO.read(getClass().getResource("/img/style01/about03.png"));
      aboutButton = image[7];
